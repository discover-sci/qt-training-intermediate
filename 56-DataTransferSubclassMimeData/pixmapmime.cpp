...
PixmapMime::PixmapMime(QPixmap pix, QPoint offset, QString description)
    : QMimeData{},
    mPix{pix},
    mOffset{offset},  // the offset for the mouse pointer to show up in the same place of moving pix as it was clicked in the original pix
    mDescription{description} {

  this->mMimeFormats << "text/html" << "text/plain";
}
